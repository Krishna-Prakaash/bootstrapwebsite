...
<body>
    <div class="container-fluid">
        <div class="row">
            <img src="https://bprd.nic.in/images/GY1.jpg"   style="height:410px;"  alt="police">
            ...
            <div class="col-sm-2 h2  bg-warning  bg-gradient"><a href="/static/about.html">ABOUT US</a></div>
            ...
            <div class="col-sm-2 h2  bg-warning  bg-gradient"><a href="/static/contactus.html">CONTACT US</a></div>
                <img src="https://bprd.nic.in/WriteReadData/Gallery/PhotoGallery/Thumbnail/NPM%20third%20NC.JPG"   style="height:810px;"  alt="police">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr scope="row">1</tr>
                    <td class="col-sm-3 h3 bg-danger bg-gradient">1</td>
                    <td class="col-sm-9 h3 bg-danger bg-gradient">Evolution of BPRD</td>
                </tbody>
                <tbody>
                    <tr scope="row">2</tr>
                    <td class=" col-sm-3 h3 bg-danger bg-gradient">2</td>
                    <td class=" col-sm-9 h3 bg-danger bg-gradient">Awards/Medals</td>
                </tbody>
                <tbody>
                    <tr scope="row">3</tr>
                    <td class=" col-sm-3 h3 bg-danger bg-gradient">3</td>
                    <td class=" col-sm-9 h3 bg-danger bg-gradient">Organization</td>
                </tbody>
            <tbody>
                <tr scope="row">4</tr>
                <td class="col-sm-3 h3 bg-danger bg-gradient">4</td>
                <td class="col-sm-9 h3 bg-danger bg-gradient">Work Allocation</td>
            </tbody>
            <tbody>
                <tr scope="row">5</tr>
                <td class=" col-sm-3 h3 bg-danger bg-gradient">5</td>
                <td class=" col-sm-9 h3 bg-danger bg-gradient">Draft Legislation</td>
            </tbody>
            <tbody>
                <tr scope="row">6</tr>
                <td class=" col-sm-3 h3 bg-danger bg-gradient">6</td>
                <td class=" col-sm-9 h3 bg-danger bg-gradient">Citizen Corner</td>
            </tbody>
    ...
    <marquee>THANK YOU FOR VISITING OUR WEBSITE</FORm></marquee>
    <footer>THIS WEBSITE WAS DEVELOPED BY KRISHNA PRAKAASH D M</footer>
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/admin.html">ADMIN</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/contactus.html">CONTACT US</a></div>
            <h2 class="text-center bg-warning">Home>>About Us>>Evolution of BPRD</h2>
            ...
            <footer>THE WEBSITE WAS DEVELOPED BY  KRISHNA PRAKAASH D M</footer>
        </body>
        <style>
            marquee{
                font-size: 50px;
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/admin.html">ADMIN</a></div>
            <div class="col-sm-2 h2  bg-warning bg-gradient"><a href="/static/contactus.html">CONTACT US</a></div>
            <h2 class="text-center bg-warning">Home>>Contact Us Page</h2>
            <div class="h2 bg-primary" style="height:800px;">
                Address:</br>
            ...
            <marquee>THANK YOU FOR VISITING YOUR WEBSITE</marquee>
            <footer>THE WEBSITE WAS DEVELOPED BY  KRISHNA PRAKAASH D M</footer>
